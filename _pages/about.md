...
<details> <summary> Get a bit nerdy about coffee </summary>
I worked weekends in the bar at a restaurant in Oslo as a student, where I made cocktails and (horrible, trust me) coffee for customers. Somehow that got me into coffee. My setup right now is a Kingrinder K6 (manual grinder) and an Aeropress Go. I occassionally like to try different brew methods, but the aeropress is a staple. I have a monthly coffee subscription to try different beans (it's a surprise every month!). Always a joy when there's a washed kenyan variety in the box.
</details>
<details> <summary> Get a bit nerdy about "budget audiophile" hardware </summary>
I got a pair of Klipsch RP-160Ms in 2022. They completely blew my mind despite using a bad AMP that I had at the time (didn't know better). But I had to sell them when I moved to Oslo because they were too big for my tiny room. There were a few experiments but for now I am mostly content with streaming spotify lossless tracks on a mid-range IEM (Truthear Pure). That might change with so many new developments in the field lately.
</details>
